...
- **Cross-chain identity verification**: [Ethereum](/concepts/sui-for-ethereum.mdx), [Solana](/concepts/sui-for-solana.mdx), 그리고 다른 Sui address의 wallet을 기본 Sui wallet에 연결한다.
...
- [Wallet Integration Options](/guides/suiplay0x1/wallet-integration): SuiPlay0X1용 wallet 전략에 대한 종합 가이드