...
Nautilus 서버 로직은 [`src/nautilus-server`](https://github.com/MystenLabs/nautilus/tree/main/src/nautilus-server) directory에 있다. 애플리케이션을 커스터마이즈하려면 [Using Nautilus guide](/guides/developer/nautilus/using-nautilus.mdx)를 템플릿으로 참조한다.
