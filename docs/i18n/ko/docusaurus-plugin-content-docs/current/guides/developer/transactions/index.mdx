...
- Programmable transaction blocks는 네트워크에서 누구나 제출할 수 있다. 이러한 transaction에 대한 정보는 [Programmable Transaction Blocks](/guides/developer/transactions/ptbs/index.mdx)을 참조한다.
