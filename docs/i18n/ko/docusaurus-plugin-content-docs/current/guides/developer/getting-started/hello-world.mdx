...
나중에 [Connecting a Frontend](/guides/developer/getting-started/app-frontends.mdx) 가이드에서 사용하므로 두 값을 모두 기록해 둔다.
...
여러 transaction command를 함께 batch하고 싶다면 [programmable transaction blocks](/guides/developer/transactions/ptbs/prog-txn-blocks)를 사용할 수 있다.
