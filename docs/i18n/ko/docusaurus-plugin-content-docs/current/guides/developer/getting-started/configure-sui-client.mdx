...
이 명령이 `sui not found`를 반환하면 Sui가 설치되지 않은 것이므로 [follow the installation instructions](/guides/developer/getting-started/sui-install.mdx).
...
[Create a Sui Address](/guides/developer/getting-started/get-address.mdx)에서 Sui address에 대해 더 알아본다.
