...
Sui GitHub repository의 Docker 또는 source code를 사용하여 [Sui full node](./sui-full-node.mdx)를 설정하고 구성할 수 있다.
...
서명 유효성 요구 사항에 대한 자세한 내용은 [Sui Signatures](/guides/developer/transactions/transaction-auth/auth-overview)를 참고한다.
