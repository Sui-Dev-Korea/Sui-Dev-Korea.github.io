...
- **Archival Service:** 이 스토어에 대한 접근을 노출해 과거 데이터의 포인트 조회를 가능하게 하는 [gRPC API (LedgerService)](/concepts/data-access/grpc) 계층이다.
