...
Compatible | 가장 느슨한 정책이다. 더 제한적인 정책이 허용하는 것에 더하여, 패키지의 업그레이드 버전에서: <ul>
<li>모든 함수 구현을 변경할 수 있다.</li>
<li>함수 시그니처의 제네릭 타입 파라미터에 대한 ability 제약을 제거할 수 있다.</li>
<li>
<code>private</code>, <code>public(friend)</code>, <code>entry</code> 함수 시그니처를 변경, 제거하거나 <code>public</code>으로 만들 수 있다.</li>
<li>
<code>public</code> 함수 시그니처는 변경할 수 없다(이전에 언급한 ability 제약의 경우는 제외).</li>
